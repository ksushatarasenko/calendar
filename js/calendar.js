...
// ===============================
console.log("📅 CALENDAR INIT — файл calendar.js загружен");

try {
    console.log("📅 Проверка DOM:", document.body ? "OK" : "нет тела документа");
    console.log("📅 Проверка контейнера календаря:", document.getElementById("calendar") || "НЕ НАЙДЕН");
} catch (e) {
    console.error("❌ Ошибка при первичной проверке calendar.js:", e);
}
